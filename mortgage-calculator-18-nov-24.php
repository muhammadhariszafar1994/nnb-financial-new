                    ...
                    <div class="form motgageForm">
                        <form id="prices">
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" step="0.01" value="1.25" id="propertyTax"
                                    name="propertyTax" />
                            </div>
                            <div class="">
                                <label>Homeowners Insurance</label>
                                <input type="text" data-type="currency" value="1225.00" id="homeownersInsurence"
                                    name="homeownersInsurence" />
                            </div>
                            <div class="">
                                <label>HOA Dues Per Month</label>
                                <input type="text" value="50" data-type="currency" id="hoaDues" name="hoaDues" />
                            </div>
                            <div class="">
                                <label>Private Mortgage Insurance Per Month</label>
                                <input type="text" data-type="currency" value="0" id="pmi" name="pmi" />
                            </div>
                            <div class="">
                                <label>Extra Payment Per Month</label>
                                <input type="text" data-type="currency" value="0" id="extraPayment"
                                    name="extraPayment" />
                            </div>
                            <!--
                        <div class="">
                                ...
                                <div class="loanAmount">
                                    <ul>
                                        <li>
                                            ...
                                            <span id="totalLoanAmount">$280,000</span>
                                        </li>
                                        <li>
                                            <label>Total Interest Paid</label>
                                            <span id="totalInterestPaid">$230,738.79</span>
                                        </li>
                                        <li>
                                            <label>All Payment</label>
                                            <span id="allPayment">$766,738.79</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul>
                                <li>
                                    <div>
                                        ...
                                        <h6 id="principle">$1,418.72</h6>
                                    </div>
                                    <div>
                                        <span class="greBg"> HOA Dues </span>
                                        <h6 id="HOADuesSpan">$50.00</h6>
                                    </div>
                                </li>
                                <li>
                                    <div>
                                        <span> Texas </span>
                                        <h6 id="TaxesSpan">$364.58</h6>
                                    </div>
                                    <div>
                                        <span> PMI </span>
                                ...
                                <li>
                                    <div>
                                        ...
                                        <h6 id="homeownersInsurenceSpan">$102.08</h6>
                                    </div>
                                    <div>
